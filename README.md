...
## 本项目获取地址：https://www.bishecode.com/product/72/
...
本电影评论网站采用SpringBoot框架，JAVA作为开发语言，是基于WEB平台的B/S架构系统。
...
图5.1 电影信息管理界面【电影评论网站的系统管理员可以管理学生，可以对电影信息添加修改删除以及查询操作。具体界面的展示如图】
![alt text](images/image-4.png)

图5.2 电影评论回复界面【系统管理员可以查看对电影评论进行回复操作。具体界面如图】
![alt text](images/image-5.png)

图5.3 电影信息界面【用户可以对电影信息进行收藏，评论操作。界面如下图所示】
